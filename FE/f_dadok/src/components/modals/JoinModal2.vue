<template>
  <div>
    <b-button v-b-modal.modal-join2 class="w-btn-neon2">회원가입</b-button>

    <b-modal id="modal-join2" ref="modal" title-html="<h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회원가입</h2>" centered>
